...
userClickPlay.addEventListener('click', function(){
    ...
    if(chosenCurrentPlay == 0){
        ...
        if(counter < 6){
            ...
            var userChoice = generateRandomNumber()
            ...
            if(userChoice !== chosenCurrentPlay && computersChoice !== chosenCurrentPlay){
                readUsersChoiceToTheUser(userChoice)
                readComputerChoiceToUser(computersChoice)
                result.textContent = "No Win because no one got it right, play again!"

            }else if(chosenCurrentPlay == userChoice && chosenCurrentPlay == computersChoice){
                readUsersChoiceToTheUser(userChoice)
                readComputerChoiceToUser(computersChoice)
